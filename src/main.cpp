...
internal void
render_floor(Obj *floor, glm::vec3 view_pos, LightObj *light, Obj *sun)
{
...
internal void
render_objects(Obj *cube, glm::vec3 view_pos, LightObj *light, Obj *sun)
{
...
update(App *app)
{
    ...
    render_floor(&app->floor, app->camera.position, &app->cube_light, &app->sun);
